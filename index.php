					...
					<div class="panel-heading">
						...
						<div class="row">
							<div class="col-xs-6">
								...
								<a href="#" class="active" id="login-form-link" style="text-align:center;">LOGIN</a>
							</div>
							<div class="col-xs-6">
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6 col-sm-offset-3">
												<input type="submit" name="login" id="login-submit" tabindex="4" class="form-control btn btn-login" style="background:cadetblue;" value="Log In">
											</div>
										</div>
									</div>
									<div class="form-group">
